...
MAKE_BITS(frame_ok, ACQ428_DCLK_STATUS, MAKE_BITS_FROM_MASK, ACQ428_ADC_FRAME_OK);
...
MAKE_BITS(afwm_spad, 	AGG_FIFO_WMASK, MAKE_BITS_FROM_MASK, AFWM_SPAD);
