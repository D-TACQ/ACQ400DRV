...
MAKE_BITS(pkt_seq, CPSC2_DAC_PKT_SEQ, MAKE_BITS_FROM_MASK, ~1);
MAKE_BITS(proc_sta, CPSC2_DAC_PROC_STA, MAKE_BITS_FROM_MASK, ~1);
MAKE_BITS(math_sta, CPSC2_DAC_MATH_STA, MAKE_BITS_FROM_MASK, ~1);
...
const struct attribute *cpsc2_dac_attrs[] = {
	...
	&dev_attr_proc_sta.attr,
	&dev_attr_math_sta.attr,
	NULL
};
