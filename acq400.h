...
#define DIO_SAMPLE_CTR		ADC_SAMPLE_CTR
...
#define ACQ428_CALIB_WINDOW_1   (ADC_BASE+0x68)
#define ACQ428_CALIB_WINDOW_2   (ADC_BASE+0x6c)
...
#define ACQ423_SAMPLE_RAM_1	(ADC_BASE+0x100)
#define ACQ423_SAMPLE_RAM_3	(ADC_BASE+0x104)
#define ACQ423_SAMPLE_RAM_5	(ADC_BASE+0x108)
#define ACQ423_SAMPLE_RAM_7	(ADC_BASE+0x10C)
#define ACQ423_SAMPLE_RAM_9	(ADC_BASE+0x110)
#define ACQ423_SAMPLE_RAM_11	(ADC_BASE+0x114)
#define ACQ423_SAMPLE_RAM_13	(ADC_BASE+0x118)
#define ACQ423_SAMPLE_RAM_15	(ADC_BASE+0x11C)
#define ACQ423_SAMPLE_RAM_17	(ADC_BASE+0x120)
#define ACQ423_SAMPLE_RAM_19	(ADC_BASE+0x124)
#define ACQ423_SAMPLE_RAM_21	(ADC_BASE+0x128)
#define ACQ423_SAMPLE_RAM_23	(ADC_BASE+0x12C)
#define ACQ423_SAMPLE_RAM_25	(ADC_BASE+0x130)
#define ACQ423_SAMPLE_RAM_27	(ADC_BASE+0x134)
#define ACQ423_SAMPLE_RAM_29	(ADC_BASE+0x138)
#define ACQ423_SAMPLE_RAM_31	(ADC_BASE+0x13C)
...
#define ACQ426_ADC_CTRL_CALIB	(1 << 16)
...
#define DAC_CTRL_CHMAP_REVERSE  (1 << 21)
...
#define ACQ426_BCSR_LOS		(1<<31)
#define ACQ426_BCSR_BSY		(1<<30)
#define ACQ426_BCSR_VSET	(1<<1)
#define ACQ426_BCSR_VA_EN	(1<<0)

#define ACQ428_ADC_CTRL_RESOLUTION_18B	(1 << 6)
#define ACQ428_ADC_CTRL_IDELAY_EN (1 << 16)
#define ACQ428_ADC_CTRL_SYNC_EN (1 << 17)
#define ACQ428_ADC_CTRL_CLK_SEL (1 << 19)
#define ACQ428_ADC_FRAME_OK (1<<31)
#define ACQ428_BANK_XRM_D37_MODE    (1<<6)
...
#define ACQ426_FIFO_STA_CAL_COMP (0xf0000000)
#define ACQ426_FIFO_STA_CAL_FAIL (0x0f000000)
...
#define HAS_NACC(adev)  (IS_ADC(adev) && !IS_ACQ480(adev))

#define IS_AO420(adev)  \
	(GET_MOD_ID(adev)==MOD_ID_AO420FMC || GET_MOD_ID(adev)==MOD_ID_AO420FMC_CS2)
#define IS_AO422(adev)  (GET_MOD_ID(adev)==MOD_ID_AO422FMC)
#define IS_AO42S(adev) (IS_AO420(adev)||IS_AO428(adev)||IS_AO422(adev))
#define IS_AO428(adev)  (GET_MOD_ID(adev) == MOD_ID_DAC_CELF)
#define IS_AO424(adev)  (GET_MOD_ID(adev) == MOD_ID_AO424ELF)
#define IS_AO42X(adev) 	(IS_AO42S(adev) || IS_AO424(adev) || IS_AO422(adev))
...
#define IS_DIO482ELF_XRM(adev)	(GET_MOD_ID(adev) == MOD_ID_DIO482ELF_XRM)
...
#define HAS_RGM(adev) 	(IS_ACQ43X(adev) || IS_ACQ42X(adev) || IS_ACQ480(adev) || IS_ACQ465(adev) || IS_AO424(adev) || IS_AO420(adev) || IS_AO422(adev))
...
#define AFWM_SITES		(0x3f<<18)
#define AFWM_SPAD		(1<<17)
#define AFWM_COOKED		(1<<16)
#define AFWM_RAW		(1<<15)
...
/* ACQ423 */
#define ACQ423_BANK_XRM_D37_MODE	(1<<6)
...
#define DIO482_DIRECTION_CTRL	0x44
...
#define DI460_DO_STIM		0x48

#define FLASH_GPIO (ADC_BASE+0x4c)
